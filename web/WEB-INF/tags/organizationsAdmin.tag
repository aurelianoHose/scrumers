    ...
    <tbody>
        <c:forEach items="${organizations}" var="organization" varStatus="status">
            <tr>
                ...
                <td width="*" style=" text-align: justify;"><fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${organization.added}"/></td>
                <td width="*" style=" text-align: justify;"><fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${organization.modified}"/></td>
                <td width="*" style=" text-align: justify;">${organization.del}</td>
                <td width="*" >
