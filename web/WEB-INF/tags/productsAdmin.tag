...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <td width="*"><fmt:message key="product.added" />:</td>
            <td width="*"><fmt:message key="product.modified" />:</td>
            <td width="*"><fmt:message key="product.del" /></td>
            <td width="*"></td>
        </tr>
    </thead>
    ...
    <tbody>
        <c:forEach items="${products}" var="product" varStatus="status">
            <tr>
                ...
                <td width="*" style=" text-align: justify;"><fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${product.added}"/></td>
                <td width="*" style=" text-align: justify;"><fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${product.modified}"/></td>
                <td width="*" style=" text-align: justify;">${product.del}</td>
